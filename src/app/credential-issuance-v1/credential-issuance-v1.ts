...
export class CredentialIssuanceV1 implements OnInit {
        ...
        this.apiService.resolveOpenIdMetadataFromDeeplink(decodedDeeplink?.credential_issuer)
            .pipe(
                ...
                switchMap((accessToken: any) => {
                    ...
                    return of(this.credentialService.decodeResponse(jwt, this.registryEntry(), this.metadata()?.credential_issuer))
    ...
    async ngOnInit(): Promise<void> {
        const {publicKey, privateKey, jwk} = await this.credentialService.createKeySet();

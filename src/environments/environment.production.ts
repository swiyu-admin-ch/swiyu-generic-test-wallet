export const environment = {
  // at the moment, the same URL is used for both development and production, but this can be changed in the future if needed
  trustApiBaseUrl:
    "https://trust-data-service-int-a.apps.p-szb-ros-shrd-npr-01.cloud.admin.ch",
